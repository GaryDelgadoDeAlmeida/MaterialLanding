...
export default function Contact() {
    ...
    return (
        <section id={"contactus"} className={"page-section c-white"}>
                    ...
                    <div className={"-item"}>
                        <div className={"-contact-coordinates"}>
                            <div className={"-coordinate"}>
                                <img src={`${window.location.origin}/content/svg/pinpoint.svg`} alt={""} />
                                <span>89, Avenue aux 100 gouffre aux suffres, France</span>
                            </div>
                            <div className={"-coordinate"}>
                                <img src={`${window.location.origin}/content/svg/phone.svg`} alt={""} />
                                <span>(+33) 1 01 00 00 00</span>
                            </div>
                            <div className={"-coordinate"}>
                                <img src={`${window.location.origin}/content/svg/mail.svg`} alt={""} />
